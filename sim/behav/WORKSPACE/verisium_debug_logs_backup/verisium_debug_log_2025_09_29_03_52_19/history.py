...
# history.py generated at 2025/09/28 23:52:19
# host: ece-rschsrv.ece.gatech.edu
# port: 37531
# launch command: indago -connect dc:ece-rschsrv.ece.gatech.edu:52809 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37531,
        extra_args='-connect dc:ece-rschsrv.ece.gatech.edu:52809 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37531
# Verisium: **************************************************************************************
